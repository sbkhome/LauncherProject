...
import com.android.medianet.launcher.presentation.util.IntSet;
import com.android.medianet.launcher.presentation.util.Utilities;
...
public abstract class PagedView extends ViewGroup {
    ...
    public PagedView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mIsRtl = false;//Utilities.isRtl(getResources());

        mScroller = new OverScroller(context, new ScrollInterpolator());
        mCurrentPage = 0;
