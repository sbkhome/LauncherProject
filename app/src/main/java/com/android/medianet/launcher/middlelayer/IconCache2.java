...
public class IconCache2 {
    ...
    public IconCache2(Context context) {
        mContext = context;
   ...
   /* private Bitmap createIconByType (int appType){
    ...
    public void update (ComponentName component, LauncherActivityInfo resolveInfo){
        remove (component);
        synchronized (mCache) {
    ...
    publie Bitmap getIcon(ComponentName component, ResolveInfo resolveInfo) {
