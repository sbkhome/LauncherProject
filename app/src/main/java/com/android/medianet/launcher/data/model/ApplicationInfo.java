...
public class ApplicationInfo extends ItemInfo {
    ...
    public ApplicationInfo(ResolveInfo info, IconCache iconCache) {
        ...
        iconCache.geTitleAndIcon(this, info);
    }

    public ApplicationInfo(LauncherActivityInfo info, IconCache iconCache) {
    ...
    public static Intent makeLaunchIntent(ResolveInfo info) {
        return makeLaunchIntent(new ComponentName(info.activityInfo.packageName, info.activityInfo.name));
    }
